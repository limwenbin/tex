...
\begin{center}
     \Large{\underline{MA3269 Mathematical Analysis I}} \\
\end{center}
...
\frac{f^{(n+1)}(c)}{(n+1)!} (b-a)^{n+1}$ for some $c \in (a,x)$; %THIS MIGHT BE WRONG
...
To find $s_n$ given $(s_1, \ldots, s_n)$ and $n$-year coupon bond, solve
	$P = \frac{c_1}{1+s_i} + \ldots + \frac{c_1}{1+s_i}$.
